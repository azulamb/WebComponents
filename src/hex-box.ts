interface HexBoxElement extends HTMLElement
{
}
...
{
	class HexBox extends HTMLElement implements HexBoxElement
	{
		public static Init( tagname = 'hex-box' )
		{
		...
		private drawHex()
		{
			//this.hex.setAttribute( 'd', 'M 50,0 L 100 20 V 80 L 50,100 L 0,80 V 20 z' );
